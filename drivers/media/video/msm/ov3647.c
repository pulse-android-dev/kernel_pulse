...
int32_t ov3647_video_config(enum sensor_mode_t       mode,
...
int32_t ov3647_snapshot_config(enum sensor_mode_t mode)
{
    int32_t rc = 0;
...
int32_t ov3647_move_focus(enum sensor_move_focus_t direction,
                          int32_t                  num_steps)
{
...
int32_t ov3647_set_sensor_mode(enum sensor_mode_t       mode,
                               enum sensor_resolution_t res)
{
    int32_t rc = 0;
...
int ov3647_probe(struct i2c_client *         client,
